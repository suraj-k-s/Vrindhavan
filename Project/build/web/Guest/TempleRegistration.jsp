<%-- 
    Document   : TempleRegistration
    Created on : 6 Jan, 2024, 12:35:27 PM
    Author     : PSST
--%>
...
<html>
    <head>
        ...
        <title>TempleRegistration</title>
    </head>
    <%@include file="Head.jsp" %>
    <body>
        <form method="post" enctype="multipart/form-data" action="../Assets/ActionPage/TempleAction.jsp">
            <table border="1">
                <tr>
                    <td>Name</td>
                ...
                <tr>
                    <td>Contact</td>
                    <td><input type="text" name="txt_contact" required="" title="Phone number with 7-9 and remaing 9 digit with 0-9"/></td>
                ...
                <tr>
                    <td>Pincode</td>
                    <td><input type="text" name="txt_pincode" required=""></td>
                <tr>
                    <td>Photo</td>
