    ...
    <body>
        <div class="site-wrap">
            ...
            <header class="site-navbar py-4" role="banner">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-3">
                            <h1 class="site-logo"><a href="index.html" class="h2">Vrindhavan<span class="text-primary">.</span> </a></h1>
                        </div>
                        <div class="col-9">
            ...
            <div class="container pt-5 hero">
                <div class="row align-items-center text-center text-md-left" align="center">
                    <div id="tab" class="col-md-6 offset-md-3" align="center"><br><br>