...
<%
    ...
    if (request.getParameter("btn_pay") != null) {
        ...
        if (mode.equals("queue")) {
            upQry = "update tbl_queuebooking set qbooking_status=1 where qbooking_id ='" + id + "'";
            location = "ViewQueueBooking.jsp";
        }
        else if (mode.equals("vazhipad")) {
            upQry = "update tbl_vazhipadbooking set vbooking_status=1 where vbooking_id='" + id + "'";
            location = "ViewVazhipadBooking.jsp";
        }
        else if (mode.equals("prasadam")) {
            upQry = "update tbl_prasadambooking set pbooking_status=1 where pbooking_id='" + id + "'";
            location = "ViewPrasadamBooking.jsp";
        }

        if (conn.executeCommand(upQry)) {
            %>
            <script>
