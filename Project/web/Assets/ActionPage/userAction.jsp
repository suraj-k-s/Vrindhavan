...
//checking if request cotains multipart data
            ...
            //f_item=(FileItem)itr.next();
                        ...
                        if (field_name.equals("file"))//write the name of image here it is img_product
                        {
                            ...
                            photo = "User_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
...
//                        }
           ...
           //to upload proof of doctor
               ...
               // {//Strinh str1="insert into tbl_user ()";//inserting file
                String InsQry = "insert into tbl_user(user_name,user_contact,user_email,user_address,user_photo,place_id,user_username,user_password)values('" + value[0] + "','" + value[2] + "','" + value[1] + "','" + value[3] + "','" +photo + "','" + value[5] + "','" + value[6] + "','"+ value[7] +"')";
