...
<html>
    ...
    <body>
        ...
        <%
            String sel = "select * from tbl_prasadambooking pb inner join tbl_prasadam p on p.prasadam_id=pb.prasadam_id inner join tbl_user t on t.user_id=pb.user_id  where temple_id='" + session.getAttribute("Tid") + "'";
